...
/// Run the full naive evaluation pipeline.
///
/// Steps:
/// 1. Spawn agents for the document's domain
/// 2. Align sections to criteria
/// 3. Debate loop: score -> challenge -> re-score until convergence or max rounds
/// 4. Moderation: trust-weighted consensus
/// 5. Rules: mine facts from argument graph
/// 6. Gate: verify scores against structural evidence
///
/// `mock_scores` provides deterministic LLM scores for benchmarking.
