...
```sh
cd crates/bench-tardygrada
make bench_pure_simple
./bench_pure
```

### Bring your own scores
Edit `data/bench_scores.json` with outputs from your own subagents and re-run.
...
The pure C benchmark uses self-hosted.
